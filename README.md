...
Optional TypePHP native accelerator for [eloquage/embed](https://github.com/eloquage/embed).
...
```
php_eloquage_embed-X.Y.Z_php8.5-x86_64-Linux-glibc-N-debug-NTS.tar.gz
```
